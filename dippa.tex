...
\begin{abstractpage}[english]
    ...
    Pseudolabels achieved a higher mIoU score (0.54) than the pre-existing annotations (0.48), and pseudolabeling improved inference results for models trained on RGB images (mIoU 0.47 $\rightarrow$ 0.53) and models trained on multispectral images (mIoU 0.53 $\rightarrow$ 0.62).
...
\begin{abstractpage}[finnish]
    ...
    Pseudoannotaatiot saavuttivat korkeamman mIoU tuloksen (0.54) kuin alkuperäiset annotaatiot (0.48). Pseudoannotaatio paransi myös inferenssituloksia sekä RGB-kuvilla koulutetulla mallilla (mIoU 0.47 $\rightarrow$ 0.53), että multispektrikuvilla koulutetulla mallilla (mIoU 0.53 $\rightarrow$ 0.62).
...
\item How much does SAM2 pseudolabeling improve training results in instance segmentaion tasks in aerial imagery?
